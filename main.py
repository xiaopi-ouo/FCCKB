...
parser.add_argument("-t", "--prepend_title", help="prepend title or not", default=True, type=bool)
...
if __name__ == "__main__":
    ...
    retrieval_result = retriever.retrieve(samples, k=args.k, prepend_title=args.prepend_title)
